            ...
            <div className="about-desc"><div className="horizon"></div><i class="fas fa-users" id="team"></i><div className="horizon"></div></div>
                <div className="about-row">
                    <div className="about-card">
                        <div className="about-img"><img alt="profile" src="/Images/devB.png" /></div>
                    ...
                    <div className="about-card">
                        <div className="about-img"><img alt="profile" src="/Images/mohitB.png" /></div>
                    ...
                    <div className="about-card">
                        <div className="about-img"><img alt="profile" src="/Images/manavB.png" /></div>
